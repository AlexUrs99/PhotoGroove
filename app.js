...
var $author$project$PhotoGroove$getUrlOfSelectedPhoto = F2(
	function (status, url) {
		switch (status.$) {
			case 'Loaded':
				var photos = status.a;
			...
			case 'GotRandomPhoto':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							status: A2($author$project$PhotoGroove$getUrlOfSelectedPhoto, model.status, photoUrl.url)
						}),
			...
			case 'ClickedPhoto':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							status: A2($author$project$PhotoGroove$getUrlOfSelectedPhoto, model.status, photoUrl)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ClickedSurpriseMeButton':
...
var $author$project$PhotoGroove$ClickedSurpriseMeButton = {$: 'ClickedSurpriseMeButton'};
...
var $author$project$PhotoGroove$ClickedSizeRadioButton = function (a) {
	return {$: 'ClickedSizeRadioButton', a: a};
};
var $elm$html$Html$input = _VirtualDom_node('input');
var $elm$html$Html$label = _VirtualDom_node('label');
var $elm$html$Html$Attributes$name = $elm$html$Html$Attributes$stringProperty('name');
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $author$project$PhotoGroove$viewRadioButton = function (size) {
	return A2(
		$elm$html$Html$label,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGroove$ClickedSizeRadioButton(size))
					]),
				_List_Nil),
				$elm$html$Html$text(
...
var $author$project$PhotoGroove$viewThumbnail = F2(
	function (selectedPhotoUrl, photo) {
		return A2(
			$elm$html$Html$img,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							'selected',
							_Utils_eq(photo.url, selectedPhotoUrl))
						])),
					$elm$html$Html$Events$onClick(
...
var $author$project$PhotoGroove$viewLoaded = F3(
	function (photos, selectedPhoto, chosenSize) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$PhotoGroove$ClickedSurpriseMeButton)
					]),
				_List_fromArray(
					[
				...
				A2(
					$elm$core$List$map,
					$author$project$PhotoGroove$viewRadioButton,
					_List_fromArray(
				...
				A2(
					$elm$core$List$map,
					$author$project$PhotoGroove$viewThumbnail(selectedPhoto),
					photos)),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src($author$project$PhotoGroove$urlPrefix + ('large/' + selectedPhoto))
					]),
				_List_Nil)
			]);
	});
	...
	return A2(
		...
		function () {
			...
			switch (_v0.$) {
				...
				case 'Loaded':
					var photos = _v0.a;
					var selectedPhoto = _v0.b;
					return A3($author$project$PhotoGroove$viewLoaded, photos, selectedPhoto, model.chosenSize);
				default:
					var errorMessage = _v0.a;
					return _List_fromArray(
						[
							$elm$html$Html$text('Error when retrieving photos: ' + errorMessage)
						]);
			}
		}());
};
